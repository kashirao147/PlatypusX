...
namespace PhoenixaStudio
{
    public class Purchaser : MonoBehaviour, IStoreListener
    {
        ...
        void Start()
        {
            ...
            //rewardTxt1.text = reward1 + "";
            //rewardTxt2.text = reward2 + "";
        }
        ...
        // --- IStoreListener
        //
        public string iapPriceText1, iapPriceText2, iapPriceText3, iapRemoveAdText;
        ...
        public void OnInitialized(IStoreController controller, IExtensionProvider extensions)
        {
            ...
            iapPriceText1 = m_StoreController.products.WithID(item1).metadata.localizedPriceString;
            iapPriceText2 = m_StoreController.products.WithID(item2).metadata.localizedPriceString;
            iapPriceText3 = m_StoreController.products.WithID(item3).metadata.localizedPriceString;
            iapRemoveAdText = m_StoreController.products.WithID(removeAds).metadata.localizedPriceString;
        }
